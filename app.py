...
DBPWD = os.environ.get("DBPWD") or "your_new_password"
DATABASE = os.environ.get("DATABASE") or "employees"
DBPORT = int(os.environ.get("DBPORT", 3306))

# Environment variables for S3 image URL and header name
#final push to git
S3_IMAGE_URL = os.environ.get('BACKGROUND_IMAGE_URL') or "https://ciril.s3.amazonaws.com/lake.jpg"
header_name = os.environ.get('HEADER_NAME') or "Ciril - Amal Employee Webpage"
